...
<title>All Newest Perfume</title>
...
<c:if test="${not empty addCart}">
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			List<PerfumeDtls> list3 = dao3.getAllOldPerfume();
			...
			<div class="col-md-2.5">
				<div class="card crd-ho">
					<div class="card-body text-center">
						...
						<p>Categories :<%=b.getperfumeCategory()%></p>
						<div class="row">
							<%
							if(u==null) {
							%>
							...
							%>
							<a href="cart?bid=<%=b.getperfumeID() %>&&uid=<%=u.getId() %>&&source=jsp2" class="btn btn-danger btn-sm ml-5">Add Cart</a>
							<%
							}
							%>
