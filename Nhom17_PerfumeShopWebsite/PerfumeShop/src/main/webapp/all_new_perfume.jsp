...
<c:if test="${not empty addCart}">
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			List<PerfumeDtls> list = dao.getAllNewPerfume();
				...
				<div class="card crd-ho">
					<div class="card-body text-center">
						...
						<div class="row">
							...
							%>
							<a href="cart?bid=<%=b.getperfumeID() %>&&uid=<%=u.getId() %>&&source=jsp1" class="btn btn-danger btn-sm ml-5">Add Cart</a>
							<%
							}
							%>
